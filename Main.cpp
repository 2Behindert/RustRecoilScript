...
int main()
{
	...
	::RegisterClassEx(&wc);
	HWND hwnd = ::CreateWindow(wc.lpszClassName, _T(("2Behindert New Recoil Script")), WS_OVERLAPPEDWINDOW, 0, 0, 50, 50, NULL, NULL, wc.hInstance, NULL);
	...
	while (!done)
	{
		...
		ImGui::NewFrame();
		{
			ImGui::Begin(("Artichoke by 2Behindert"));
			{
				ImGui::BeginGroup();
